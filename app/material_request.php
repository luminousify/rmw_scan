          ...
          <div class="item-row border border-gray-200 rounded-lg p-4 mb-4 bg-gray-50" data-item="${itemCounter}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <div>
                ...
                <input type="text" name="items[${itemCounter}][machine]" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Opsional">
              </div>
            </div>
